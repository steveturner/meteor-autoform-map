...
initTemplateAndGoogleMaps = function() {
  ...
  if (this.data.atts.searchBox) {
    ...
    google.maps.event.addListener(searchBox, 'places_changed', (function(_this) {
      return function() {
        ...
        console.log("About to call this.data.setMarker #2.  this.data is " + this.data + ". Map is " + this.data.map + ". Location is " + location + ".");
  ...
  if (this.data.atts.autolocate && navigator.geolocation && !this.data.value) {
    navigator.geolocation.getCurrentPosition((function(_this) {
      return function(position) {
        ...
        console.log("About to call this.data.setMarker #3.  this.data is " + this.data + ". Map is " + this.data.map + ". Location is " + location + ".  Zoom is " + this.data.options.zoom + ".");
  ...
  google.maps.event.addListener(this.data.map, 'click', (function(_this) {
    return function(e) {
      console.log("About to call this.data.setMarker #4.  this.data is " + this.data + ". Map is " + this.data.map + ". latLon is " + e.latLng + ".");
