...
initTemplateAndGoogleMaps = function() {
  ...
  if (this.data.value) {
    ...
    console.log("About to call this.data.setMarker #1.  this.data: ");
    ...
    console.log(location);
    console.log("Zoom:");
    console.log(this.data.options.zoom);
  ...
  if (this.data.atts.searchBox) {
    ...
    google.maps.event.addListener(searchBox, 'places_changed', (function(_this) {
      return function() {
        ...
        console.log("About to call this.data.setMarker #2.  this.data: ");
        console.log(_this.data);
        console.log("Map:");
        console.log(_this.data.map);
        console.log("Location:");
        console.log(location);
  ...
  if (this.data.atts.autolocate && navigator.geolocation && !this.data.value) {
    navigator.geolocation.getCurrentPosition((function(_this) {
      return function(position) {
        ...
        console.log("About to call this.data.setMarker #3.  this.data:");
        console.log(_this.data);
        console.log("Map:");
        console.log(_this.data.map);
        console.log("Location:");
        console.log(location);
        console.log("Zoom:");
        console.log(_this.data.options.zoom);
  ...
  google.maps.event.addListener(this.data.map, 'click', (function(_this) {
    return function(e) {
      console.log("About to call this.data.setMarker #4.  this.data:");
      console.log(_this.data);
      console.log("Map:");
      console.log(_this.data.map);
      console.log("latLng:");
